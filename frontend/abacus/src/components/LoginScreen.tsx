  ...
  return (
    <div className="min-h-screen bg-slate-900 flex items-center justify-center">
      <div className="bg-slate-800 rounded-2xl p-8 w-full max-w-sm shadow-xl">
        <h1 className="text-2xl font-bold text-white mb-2">Abacus</h1>
        <p className="text-slate-400 mb-8 text-sm">Tracker de inversiones</p>
        ...
        {IS_DEV && (
          <button
            type="button"
            onClick={devLogin}
            className="w-full bg-slate-700 hover:bg-slate-600 text-slate-200 font-medium py-2.5 px-4 rounded-lg transition-colors text-sm"
          >
